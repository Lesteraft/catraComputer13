                ...
                case '10':
                    {
                        ...
                        $("#consolaSalida").css('display', 'none');
                        $("#consolaEntrada").css('display', 'block');
                        ingreso = $('#consolaEntradaInput').val();
                        $("#consolaEntrada").css('display', 'none');
                        memoria[memoriaOp] = ingreso;
                        break;
                    }
                case '11':
                    {
...
function almacena(posicion, objeto) {
    setTimeout(() => {
        console.log(memoria);
    }, 10);
...
/*
$("#consolaEntrada").keydown(
    function(e) {
        var ingreso;
        if (e.which == 13) {
            ingreso = $('#consolaEntradaInput').val();
            console.log('de dió enter: ' + ingreso);
            ingreso = $('#consolaEntradaInput').val('');
            $("#consolaEntrada").css('display', 'none');
            memoria[memoriaOp] = ingreso;
        }
